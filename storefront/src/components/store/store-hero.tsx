    ...
    <div className="flex flex-col">
      <div className="relative h-[400px] w-full overflow-hidden md:h-[500px] lg:h-[674px]">
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="mx-auto w-full max-w-[1512px] px-6">
      ...
      {features.length > 0 && (
        <div className="bg-[#C5AF71]">
          <div className="content-container flex flex-wrap items-center justify-center gap-4 px-6 py-4 text-center text-sm font-normal text-black md:gap-8 md:text-base lg:gap-12 lg:text-lg">
