...
interface ControlUnitDetailAccordionProps {
  advantages: string[]
  specifications: Record<string, string>
  downloads: Download[]
}

export function ControlUnitDetailAccordion({ advantages, specifications, downloads }: ControlUnitDetailAccordionProps) {
  return (
    <ProductAccordion>
