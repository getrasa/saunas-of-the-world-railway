...
import { CartButton } from "./actions.cart-button"

export interface TopbarActionsProps {
  isStore?: boolean
}

const TopbarActions: React.FC<TopbarActionsProps> = ({ isStore = false }) => {
  ...
  return (
    <div className="flex items-center justify-end gap-6 tracking-widest">
      ...
      <div
        onClick={() =>
          window.open("https://maps.app.goo.gl/WMaiYnUyMasSxYB4A", "_blank")
        }
