...
const TopbarDesktop: React.FC<TopbarDesktopProps> = ({ isStore = false }) => {
  ...
  return (
    <div className={`${isStore ? 'max-w-[1512px]' : 'container'} px-[52px] flex h-28 w-screen items-center justify-between transition-all duration-300`} style={{ height: topbarHeight }}>
      <Logo />
      <div
