...
import { AccessoryDetailScene } from "~/components/store/accessories/details/product-detail.scene"
import { getRegion } from "@lib/data/regions"
import { getAccessoryContent } from "~/lib/data/accessory-content"
import { HttpTypes } from "@medusajs/types"

export const revalidate = 0

export default async function AccessoryDetailsPage(props: { params: Promise<{ id: string }> }) {
  ...
  // Fetch accessory content from Payload CMS
  const accessoryContent = await getAccessoryContent(product.id)

  return (
    <AccessoryDetailScene
      product={product}
