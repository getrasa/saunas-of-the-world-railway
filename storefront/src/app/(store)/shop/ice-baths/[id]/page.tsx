...
import { IceBathDetailScene } from "~/components/store/ice-baths/details/product-detail.scene"
import { getRegion } from "@lib/data/regions"
import { getIceBathContent } from "~/lib/data/ice-bath-content"
import { HttpTypes } from "@medusajs/types"

export const revalidate = 0

export default async function IceBathDetailsPage(props: { params: Promise<{ id: string }> }) {
  ...
  // Fetch ice bath content from Payload CMS
  const iceBathContent = await getIceBathContent(product.id)
