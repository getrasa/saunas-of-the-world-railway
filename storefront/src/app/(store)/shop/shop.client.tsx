...
export function ShopClient({ categories }: ShopClientProps) {
  ...
  return (
    <div className="flex flex-col">
      <StoreHero
        title="Premium Sauna & Wellness Products"
        subtitle="Official EOS Partner & Distributor"
        description="Discover our comprehensive range of premium sauna heaters, infrared systems, ice baths, and accessories. Combining German engineering excellence with unmatched performance and reliability."
        backgroundImage={imageUrls.equipmentHero}
            ...
            <div className="grid gap-8 md:grid-cols-2 md:items-center">
              <div>
                ...
                <p className="mb-6 text-gray-600">
                  EOS Saunatechnik GmbH has been setting the standard for premium
                  sauna technology for over 80 years. Located in the German
                  Westerwald region, EOS manufactures high-quality sauna heaters,
                  control systems, and accessories that combine innovative design
                  with exceptional durability.
                </p>
                <p className="mb-6 text-gray-600">
                  As an authorized partner and distributor, we provide expert
                  guidance, professional installation, and comprehensive support for
                  all EOS products.
                </p>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <div className="text-3xl font-bold text-[#C5AF71]">80+</div>
                    <div className="text-gray-600">Years of Excellence</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-[#C5AF71]">5</div>
                    <div className="text-gray-600">Year Warranty</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-[#C5AF71]">100%</div>
                    <div className="text-gray-600">German Engineering</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-[#C5AF71]">24/7</div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-xl bg-white p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  Our team of sauna specialists helps you choose the perfect
                  equipment for your specific needs and space requirements.
                </p>
              </div>
              <div className="rounded-xl bg-white p-6 shadow-sm">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#C5AF71]/10">
                ...
                <p className="text-sm text-gray-600">
                  Certified technicians ensure proper installation and
                  commissioning of all equipment for optimal performance and safety.
                </p>
              </div>
              <div className="rounded-xl bg-white p-6 shadow-sm">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#C5AF71]/10">
                ...
                <p className="text-sm text-gray-600">
                  ...
                  technical support to keep your equipment running perfectly.
                </p>
              </div>
            </div>
          </div>
