...
export const AccessoryContent: CollectionConfig = {
  slug: 'accessory-content',
  access: {
    read: () => true,
  },
  admin: {
    ...
    description: 'Content for individual accessory products (advantages, specifications, downloads)',
  },
  fields: [
    {
      ...
      admin: {
        description: 'Select an accessory product from Medusa. The product name will be auto-populated.',
        components: {
      ...
      fields: [
        {
          ...
          admin: {
            description: 'e.g., "Material", "Dimensions"',
          },
        },
        {
          name: 'value',
          ...
          admin: {
            description: 'e.g., "Premium wood", "30 x 20 x 15 cm"',
          },
        },
      ],
    },
