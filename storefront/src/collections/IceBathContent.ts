...
export const IceBathContent: CollectionConfig = {
  slug: 'ice-bath-content',
  access: {
    read: () => true,
  },
  admin: {
    ...
    description: 'Content for individual ice bath products (advantages, specifications, downloads)',
  },
  fields: [
    {
      ...
      admin: {
        description: 'Select an ice bath product from Medusa. The product name will be auto-populated.',
        components: {
